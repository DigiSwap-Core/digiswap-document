...
1\. First, visit the [DigiSwap Farms page](https://digiswap.finance/farms) and search for your chosen pair using the "SEARCH" field in the top right. We're using DGP-BUSD for this example.
